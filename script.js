...
function addPriceCheck() {
    if ($('#ca-tool-content').length > 0) {
        const button = `<span id="checkMarketPricesContainer"><p style='color:white;'>Price difference check to second lowest Bazaar:</p><br><button class="ca-btn" id="checkMarketPrices" style="color: var(--default-blue-color); cursor: pointer; margin-right: 0;">Check Marketprices</button></span>`
...
/* alertify */
    ...
    $(document).on("click", "#checkMarketPrices", function () {
        ...
        var itemnames = []
        var interval = 500
        if (ca_url.indexOf("imarket.php") >= 0) {

            var exclude = [1030, 1031, 1032, 1033, 1034];
            var itemstocheck = ["Sheep Plushie", "Teddy Bear Plushie", "Kitten Plushie", "Stingray Plushie", "Wolverine Plushie", "Jaguar Plushie", "Chamois Plushie", "Nessie Plushie", "Red Fox Plushie", "Monkey Plushie", "Lion Plushie", "Panda Plushie", "Camel Plushie"];
            // $('span.searchname').each(function() {
            //   var checkid = itemarray[$(this).text()];
            //   if(exclude.includes(checkid)){
            //     //console.log("excluding " + $(this).text() + "\n");
            //     return;
            //   }
